...
contra la app real y la base de datos local. Los estados `EnCurso`/`Finalizada` se logran por
la API real (`_helpers.iniciar_sesion` e `_helpers.iniciar_y_finalizar`).
"""
