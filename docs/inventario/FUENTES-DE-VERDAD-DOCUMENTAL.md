...
> Última actualización: 2026-09-07 (rev. /docs-audit)
...
| Arquitectura de información transversal (portal de entrada, navegación) | `docs/design/domain/portal-entrada-modelo.md` | `docs/design/ux/wireframes-portal-entrada.md`, `docs/plans/inc4-adj/inc4-adj-candidatas.md` | No es un modelo de BC — vive en `docs/design/domain/` por convención de carpeta (mismo tipo de insumo de Iteración 0), pero no sigue el patrón `BC-<bc>-modelo.md` porque Portal de Entrada no es un Bounded Context. |
