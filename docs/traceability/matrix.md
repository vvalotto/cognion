...
| RF-08 | Sesiones | 6 | — | Planificado |
| RF-09 | Sesiones | 6 | — | Planificado |
| RF-10 | Sesiones | 6 | — | Planificado |
| RF-11 | Sesiones | 3 | — | Planificado |
| RF-11b | Sesiones | 3 | — | Planificado |
| RF-12 | Sesiones | 3 | — | Planificado |
| RF-13 | Sesiones | 3 | — | Planificado |
...
|---|---|---|---|---|---|---|---|
| RNF-REND-1 | Rendimiento | ADR-005 | Rendimiento, Escenario 1 | Sesiones | 6 | Planificado | Medición server-side ≤100ms con hasta 60 clientes conectados |
| RNF-DISP-1 | Disponibilidad | ADR-010 | Disponibilidad, Escenario 1 | Sesiones / Infraestructura | 0 (healthcheck) → 6 (cancelación a los 5 min) | Planificado | Healthcheck expuesto (Inc 0) + comportamiento de cancelación verificado en UAT de Inc 6 |
| RNF-DISP-2 | Disponibilidad | N/A — decisión de dominio (RF-11b), no arquitectónica | Disponibilidad, Escenario 2 | Sesiones | 3 | Planificado | RF-11b (modificación de cierre en caliente) cubre el escenario |
| RNF-CONF-1 | Confiabilidad | ADR-009, ADR-004 | Confiabilidad | Sesiones | 3 | Planificado | Test de reconexión sin pérdida de respuestas confirmadas |
...
| RNF-USA-2 | Usabilidad | ADR-011 | Usabilidad, Escenario 2 | Frontend / Sesiones en vivo | 6 | Planificado — ⚠️ ítem abierto, criterio a definir en diseño UX antes del Incremento 6 (ver `CLAUDE.md`) | Validación humana en dispositivo real (proyección en aula) |
...
| RNF-OBS-1 | Observabilidad | ADR-002, ADR-010 | Observabilidad | Sesiones | 3 | Planificado | Reconstrucción de una sesión desde el event store, verificada en UAT |
